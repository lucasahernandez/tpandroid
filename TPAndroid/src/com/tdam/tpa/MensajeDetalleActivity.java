...
public class MensajeDetalleActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detallemensaje);

		TextView persona = (TextView) findViewById(R.id.txtPersonaSMSDetalle);
		TextView fecha = (TextView) findViewById(R.id.txtFechaSMSDetalle);
		TextView body = (TextView) findViewById(R.id.txtBodySMSDetalle);
		ImageView iconoMensajes = (ImageView) findViewById(R.id.iconoMensajeD);
		// Devuelve el intent con el cual esta actividad fue iniciada
		// (getIntent)
		persona.setText(getIntent().getExtras().getString(
				MensajeListaActivity.PARAMETRO_NOMBRESMS));
		fecha.setText(getIntent().getExtras().getString(
				MensajeListaActivity.PARAMETRO_FECHASMS));
		body.setText(getIntent().getExtras().getString(
				MensajeListaActivity.PARAMETRO_BODYSMS));
		String type=getIntent().getExtras().getString(
				MensajeListaActivity.PARAMETRO_TIPOSMS);
